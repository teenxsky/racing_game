...
class Game:
    def __init__(self):
        ...
        self.screen = pg.Surface((self.SCREEN_WIDTH, self.SCREEN_HEIGHT)).convert_alpha()
        self.FPS = 60
        ...
        self.close_button_game = Button(510, 530, "images/buttons/close_button_off.png",
                                        "images/buttons/close_button_on.png", button_sound, 0.25)
        self.back_button = Button(770, 530, "images/buttons/back_button_off.png", "images/buttons/back_button_on.png",
                                  button_sound, 0.25)

        # BACKGROUND

        self.curr_level = 0
        self.game_over_bg = Picture(640, 360, "images/backgrounds/window_vert.png", 0.5)
        self.pause_bg = Picture(640, 360, "images/backgrounds/window_vert.png", 0.5)

        # HINTS

        self.hints_bg = Picture(640, 360, "images/backgrounds/hints_bg.png", 1.6)
        ...
        self.oil_stain_image = Picture(0, 0, "images/HUD/oil_stain.png", 0.65)

        self.speedometer_base = Picture(1100, 560, "images/HUD/speedometer/base.png", 1.35, set_bottomleft=True)

        # MUSIC

        self.music_player = MusicPlayer("audio/music/")
    ...
    def game_loop(self):
        ...
        add_sprites(GIF(f'images/cars/{choose_car()["name"]} topdown/', scale=0.4).gif, self.player_group,
                    "PlayerVehicle")
    ...
    def game_over(self):
        ...
        game_over_text = Text(640, 150, "GAME OVER", 50)
        game_over_text.draw(self.screen)

        coins_text = Text(640, 350, "COINS: " + str(settings.player_stats["coins"]), 30)

        score_text = Text(640, 400, "SCORE: " + str(settings.player_stats["score"]), 30)

        coins_text.draw(self.screen)
    ...
    def hud(self):
        ...
        for i in range(self.lives):
            Picture(1125 + i * 50, 40, "images/HUD/heart.png", scale=2.25).draw(self.screen)

        self.screen.blit(self.speedometer_base.image, self.speedometer_base.center)
        self.P1.rotate_arrow_of_speedometer(self.screen, "images/HUD/speedometer/arrow.png",
                                            self.speedometer_base.center, 1.35)

        self.music_player.draw_current_song(self.screen, (10, 710), set_bottomleft=True)
    ...
    def paused(self):
        ...
        paused_text = Text(640, 150, "PAUSED", 50)
        paused_text.draw(self.screen)
    ...
    def show_hints(self):
        self.hints_bg.draw(self.screen)
